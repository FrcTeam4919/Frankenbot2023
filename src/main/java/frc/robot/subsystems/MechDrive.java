...
public class MechDrive extends SubsystemBase {
  ...
  private final WPI_VictorSPX m_leftFront = new WPI_VictorSPX(DriveConstants.kFrontLeftDrive);
  private final WPI_VictorSPX m_leftRear = new WPI_VictorSPX(DriveConstants.kBackLeftDrive);
  private final WPI_VictorSPX m_rightFront = new WPI_VictorSPX(DriveConstants.kFrontRightDrive);
  private final WPI_VictorSPX m_rightRear = new WPI_VictorSPX(DriveConstants.kBackRightDrive);
